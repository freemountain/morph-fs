...
describe("VirtualFileSystemHost", () => {
    describe("constructor", () => {
        it("should have the main directory after being constructed", async () => {
            expect(await new VirtualFileSystemHost().directoryExists("/")).to.be.true;
        });
    });
    ...
    describe("VirtualFileSystemHost.readDir", () => {
